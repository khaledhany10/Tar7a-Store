...
export const products = [
  ...
  },
  {
    ...
    image: "/Shefon Sada/Shefon Sada5.jpeg",
    category: "شيفون",
    printed: false,
    bgColor: "bg-[#f8f0f8]",
    colors: [
  ...
  },
  {
    ...
    image: "/Shefon Sada/Shefon Sada6.jpeg",
    category: "شيفون",
    printed: false,
    bgColor: "bg-[#e8eaf6]",
    colors: [
...
for (let i = 13; i <= 20; i++) {
  ...
  products.push({
    ...
    image: isSada 
      ? `/Shefon Sada/Shefon Sada${baseNumber}.jpeg`
      : `/Shefon print/Shefon print ${baseNumber}.jpeg`,
    category: "شيفون",
    printed: !isSada,
    bgColor: "bg-[#f5f5f5]",
    colors: [
